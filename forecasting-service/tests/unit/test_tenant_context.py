"""Python analogue of Module 01's `TenantContextService` unit tests
(test/unit/tenant-context.service.spec.ts) - fails closed with no bound
context, rejects malformed UUIDs, isolates concurrent async tasks. No
database required.
"""
