...
JWKS client). Reused, unchanged, from forecasting-service's identical copy
(ADR-0021's own precedent for per-service copies of shared conventions
rather than a cross-service Python package).
"""
