...
/**
 * ADR-0163: own copy of the same guard every other RBAC-gated service in
 * this platform uses. Checks `request.tokenClaims.permissions` (§3.4's
 * flat `["resource:action", ...]` claim) against `@RequirePermissions(...)`.
