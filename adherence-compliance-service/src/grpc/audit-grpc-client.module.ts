...
/**
 * Phase 5 (docs/adr/0104, §6): the audit trail for "activated a compliance
 * rule despite a flagged non-compliant preview." Own copy of
 * attendance-leave-service's identical `AuditGrpcClientModule` - this
 * platform's second adopter of core's `AuditService.RecordEvent`
 * (ADR-0079), not a new mechanism.
 *
