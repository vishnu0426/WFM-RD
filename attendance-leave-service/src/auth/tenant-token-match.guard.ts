...
/**
 * ADR-0150/ADR-0157. Own copy of mobile-ess-service's guard - second guard
 * in `@UseGuards(AccessTokenGuard, TenantTokenMatchGuard)`, same pattern
 * ai-layer-service/integration-hub-service/mobile-ess-service already
 * established (docs/adr/0130, docs/adr/0145). Tenant scope comes from an
 ...
 * valid token for tenant A holding a working session would still pass with
 * a spoofed `x-tenant-id: B` header.
 *
