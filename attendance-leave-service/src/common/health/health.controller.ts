 ...
 * for everything it owns (unlike Module 05, there is no Redis-fatal/
 * Postgres-non-fatal asymmetry here to reproduce - this service has no
 * live-state cache in Phase 1). A Postgres outage means this instance
 * cannot serve a correct read or write, so it flips this endpoint to `503`.
 */
@Controller()
