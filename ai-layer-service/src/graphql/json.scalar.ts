 ...
 * `AIInteraction.inputContext`/`outputStructured` and
 * `AIRecommendation.supportingDataJson`/`AIGovernancePolicy.riskThresholdConfig`
 * - all genuinely variable-shape JSON, not a fit for a typed GraphQL object.
 */
@Scalar('JSON', () => Object)
