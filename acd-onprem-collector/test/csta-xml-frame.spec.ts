 ...
 * own doc comment) - this test builds frames by hand, byte-by-byte,
 * against the standard's own description rather than by round-tripping
 * through `encodeCstaFrame`, so a bug in encode and a matching bug in
 * decode can't cancel out. Same test suite as
 * `integration-hub-service/test/unit/sync/csta-xml-frame.spec.ts`, since
 * this is a verbatim port of that module.
 */
